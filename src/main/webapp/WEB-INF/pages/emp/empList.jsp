...
<section id="container">
						...
						<div class="panel-body">
							<form class="form-inline" role="form" method="get" action="empList">
								...
								<button type="button" class="btn  btn-info" id="add_but"
										onclick="location.href='/Spring_Project/empInsert.jsp'" style="margin-left:50px;">添加员工</button>
			...
			<div class="row">
				<div class="col-lg-12" id="user_main">
					...
					<section class="panel">
						...
						<div class="panel-body">
							<section id="unseen">
								<form action="/Spring_Project/emp_delete" id="deleteForm" method="post">
										...
										<div class="dataTables_paginate paging_bootstrap pagination">
											<ul>
												...
												<c:if test="${pageNum<countMap.totalPage}">
													<li class="prev">
														<a href="empList?pageNum=${pageNum+1}">下一页</a>
													</li>
												</c:if>
												<li class="prev">
													<a href="empList?pageNum=${countMap.totalPage}">尾页</a>
												</li>
											</ul>
										</div>
									</div>
	...
	function updateUser() {
		...
		if (flag == false) {
			...
			$("#deleteForm").attr('action', "/Spring_Project/emp_selectOne");
			$('#deleteForm').submit();
		}
	}
	</script>
