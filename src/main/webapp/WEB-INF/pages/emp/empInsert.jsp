...
<form novalidate="novalidate" class="form-horizontal tasi-form"
	  method="post" id="addForm" action="/Spring_Project/emp_insert">
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-3 col-xs-11">
			<input id="sex男" name="sex" checked="checked" value="男" type="radio">
	...
	<div class="form-actions">
		<input value="添加" class="btn btn-success" type="submit"> &nbsp;&nbsp;&nbsp; <input value="取消" class="btn" id="cancel_b" type="button">
	</div>
</form>
		</div>
	</section>
