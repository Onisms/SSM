    ...
    <div class="top-nav ">
        <ul class="nav pull-right top-menu">
            <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">${ sessionScope.employee.name }</span> <b class="caret"> </b>
            </a>
                <ul class="dropdown-menu extended logout">
                    <li class="log-arrow-up"></li>
                    <li><a href="javascript:void(0)" id="configP"> <i class=" fa fa-suitcase"> </i> 个人信息
                    </a></li>
                    <li><a href="/Spring_Project/logout" id="logout"><i class="fa fa-key"> </i>注销
                    </a></li>
                </ul></li>
        </ul>
    </div>
