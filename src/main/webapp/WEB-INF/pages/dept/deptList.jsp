		...
		<div class="col-lg-12">
			<section class="panel">
				<div class="panel-body">
					<form class="form-inline" role="form" method="post" action="/Spring_Project/dept_list?pageNum=1">
						<div class="form-group">
							<label class="sr-only" for="name">部门名称</label> <input class="form-control" id="name" name="name" placeholder="部门名称" type="text">
						</div>
	...
	<div class="panel-body">
		<section id="unseen">
			<table class="table table-bordered table-striped table-condensed" id="departmentlist">
				...
				<tbody>
				     <form action="/Spring_Project/dept_delete" id="deleteForm" method="post">
		...
		<div class="dataTables_paginate paging_bootstrap pagination">
			<ul>
				...
				<c:if test="${pageNum<countMap.totalPage}">
					<li class="prev">
						<a href="deptList?pageNum=${pageNum+1}">下一页</a>
					</li>
				</c:if>
				<li class="prev">
					<a href="deptList?pageNum=${countMap.totalPage}">尾页</a>
				</li>
			</ul>
		</div>
	</div>
 ...
 function updateDepartment(){
	   ...
	   var num=0;
	    ...
	    if(flag==false){
		   ...
		   $("#deleteForm").attr('action',"/Spring_Project/dept_queryById");
			$('#deleteForm').submit();
	   }
