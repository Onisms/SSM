...
<div class="col-md-12">
	<section class="panel">
		...
		<div class="panel-body">
			<form novalidate="novalidate" class="form-horizontal tasi-form" method="post" id="addForm"
				  action="/Spring_Project/dept_update">
				<input name="id" value="${department.id}" type="hidden">
				 <input name="deptNo" value="D20170001" type="hidden">
    ...
    <textarea name="description" cols="" rows="5" id="department_comment"
			  class="wysihtml5 form-control">${department.description}
	</textarea>
